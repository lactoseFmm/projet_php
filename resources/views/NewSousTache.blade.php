...
@section('contenu')
    ...
    <div class="col-sm-offset-2 col-sm-7">
        <div class="panel panel-info">
            <div class="panel-heading" >Ajout d'une nouvelle sous-tâche</div>
            <div class="panel-body">
                {!! Form::open(array('url' => '/AddNewTask/'.$id)) !!}
                <div class="form-group {!! $errors->has('SousTache') ? 'has-error' : '' !!}">
                    {!! Form::text('SousTache', null, array('class' => 'form-control','required' ,'placeholder' => 'Nom de la nouvelle sous-tâche','maxlength'=>'40')) !!}
