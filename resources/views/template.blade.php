...
<nav class="navbar navbar-default">
    ...
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand">Listeur de tâches</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li> <!--class="active" --> <a href={{URL::to('/')}}>Ajouter une tâche <span class="sr-only">(current)</span></a></li>
                <li><a href={{URL::to('/list')}}>Voir les tâches</a></li>
